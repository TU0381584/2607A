...
replication and is retracted here rather than reported. Together these
...
mid-episode gNB dropout, demand spikes, and agent churn. We label
these three campaigns M2 (centralised), M3 (federated/privacy), and M4
...
generalisation question distinct from, and complementary to, the
evaluation-integrity question this paper asks on a single fixed
topology; whether GAT-CTDE's own correctness-aware metrics remain
reliable across topologies neither paper tests is exactly the kind of
question our metric pair is built to keep honest, and is a natural
extension of this work. Beyond admission control specifically, graph
