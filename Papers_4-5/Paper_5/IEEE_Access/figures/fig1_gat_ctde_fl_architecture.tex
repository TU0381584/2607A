...
% into the paper body. Mirrors CACS26/figures/fig1_architecture.tex's
...
\node[below=0.55cm of qbox, font=\scriptsize, align=center] (action) {accept / reject\\(decentralised execution:\\own embedding row only)};
