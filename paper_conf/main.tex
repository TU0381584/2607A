...
\node[livebox, below=0.24cm of ckpt] (arms) {4 arms: baseline, static-at-cap,\\DQN$_{\text{SLA}}$, DQN$_{\text{QoE}}$};
\node[livebox, below=0.24cm of arms] (rig) {Live OAI gNB\\(E2 loop, Fig.~\ref{fig:architecture})};
\node[evalbox, below=0.24cm of rig] (liveeval) {Live evaluation: 11 seeds, $\leq$46 ep/arm};
...
\node[font=\tiny\itshape, below=0.03cm of offeval, align=center, text width=2.5cm] {does not rank-correlate\\with live outcome (Sec.~III-C)};
\end{tikzpicture}
...
\node[draw=palBlue!70!black, dashed, rounded corners, fit=(amf)(smf1)(smf2)(smf3), inner sep=5pt, label={[font=\sffamily\bfseries\scriptsize, text=palBlue!70!black]above:Open5GS core (software)}] (core) {};
...
\node[draw=palYellow!65!black, rounded corners, fit=(mac)(e2), inner sep=5pt, label={[font=\sffamily\bfseries\scriptsize, text=palYellow!55!black]above:gNB -- OAI (ORANSlice fork), rfsim, 106 PRBs $\mu{=}1$}] (gnbbox) {};
...
Live compliance & 44/46 (95.7\%) & \textbf{46/46 (100\%)} \\
Congested URLLC MOS & 2.44 & \textbf{4.83} \\
\bottomrule
\end{tabular}
\end{table}
